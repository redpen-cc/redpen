...
public class RedPen {
     ...
     */
    public Map<Document, List<ValidationError>> validate(List<Document> documents) throws RedPenException {
        List<Validator> validators = getValidators();
        return validate(documents, validators);
    }
     ...
     * @return list of validation errors
     */
    public Map<Document, List<ValidationError>> validate(List<Document> documents, List<Validator> validators) {
        Map<Document, List<ValidationError>> docErrorsMap = new HashMap<>();
        documents.forEach(e -> docErrorsMap.put(e, new ArrayList<>()));
        runDocumentValidators(documents, validators, docErrorsMap);
        runSectionValidators(documents, validators, docErrorsMap);
        runSentenceValidators(documents, validators, docErrorsMap);
        return docErrorsMap;
    }
     ...
     * @return list of validation errors
     */
    public List<ValidationError> validate(Document document) throws RedPenException {
        List<Document> documents = new ArrayList<>();
        documents.add(document);
        // load validators
        List<Validator> validators = getValidators();
        Map<Document, List<ValidationError>> documentListMap = validate(documents, validators);
        return documentListMap.get(document);
    }

    public List<Validator> getValidators() throws RedPenException {
        // load validators
    ...
    private void runDocumentValidators(List<Document> documents, List<Validator> validators, Map<Document, List<ValidationError>> docErrorsMap) {
    ...
    private void runSectionValidators(List<Document> documents, List<Validator> validators, Map<Document, List<ValidationError>> docErrorsMap) {
    ...
    private void runSentenceValidators(List<Document> documents, List<Validator> validators, Map<Document, List<ValidationError>> docErrorsMap) {
