    ...
    public void testDocument() throws RedPenException {
        ...
        Document document =
                new Document.DocumentBuilder(new WhiteSpaceTokenizer())
                        ...
                        .addSentence("When it comes to fish, tuna is pretty nice.", 2)
                        .addSentence("When it comes to celery, the thing to consider is the crunch.", 3)
                        .addSentence("When it comes to how to start a sentence, variety is the key.", 4)
                        .addSentence("The acronym CPU stands for Central Processing Unit (CPU).", 5)
                        .addSentence("The acronym AAAS is the American Association for the Advancement of Science.", 6)
                        .build();
