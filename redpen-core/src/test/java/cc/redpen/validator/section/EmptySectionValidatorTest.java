...
public class EmptySectionValidatorTest {
    private EmptySectionValidator validator = new EmptySectionValidator();
    ...
    @Test
    public void testInvalidWithEmptySentence() {
        Document document =
                Document.builder()
                        .addSection(1)
                        .addSectionHeader("Abstract")
    ...
    public void testChangeLimit() throws RedPenException {
        ...
        Configuration config = Configuration.builder()
                .addValidatorConfig(new ValidatorConfiguration("EmptySection").addProperty("limit", "3"))
                .build();
