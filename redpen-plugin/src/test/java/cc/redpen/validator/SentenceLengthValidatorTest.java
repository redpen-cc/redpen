...
public class SentenceLengthValidatorTest extends Validator {
    @Test
    public void testValidationErrorCreation() throws RedPenException {
        Validator samplePluginValidator = new SentenceLengthValidator();
        ...
        samplePluginValidator.validate(shortSentence);
