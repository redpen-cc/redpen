...
In this article, we'll call a computer server that works as a member of a cluster an  @<strong>{instance}. for example, each instance in distributed search engines stores the the fractions of data.
